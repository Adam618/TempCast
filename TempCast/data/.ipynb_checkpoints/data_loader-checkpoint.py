...
class Dataset_Custom(Dataset):
    def __init__(self, lag_step,is_img_embed, img_channel,root_img_path, img_path, root_path,img_pred_len, flag='train', size=None,
    ...
    def __getitem__(self, index):
        ...
        img_name = self.time_x[r_begin-self.lag_step:s_end+self.img_pred_len-self.lag_step]
        ...
        if self.is_img_embed:
            ...
            # if self.scale:
            #     img_data = self.scaler.transform(img_data)
...
class Dataset_Pred(Dataset):
    def __init__(self, lag_step,is_img_embed, img_channel, root_img_path, img_path, root_path, img_pred_len, flag='train',
                 size=None,
                 features='S', data_path='ETTh1.csv',
                 target='OT', scale=True, inverse=False, timeenc=0, freq='h', cols=None):
        # size [seq_len, label_len, pred_len]
